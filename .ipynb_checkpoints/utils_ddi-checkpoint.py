"""
copyright: https://github.com/kanz76/SSI-DDI
"""
import itertools
...
df_drugs_smiles = pd.read_csv('data/drug_interaction/drug_smiles.csv')
...
df_all_pos_ddi = pd.read_csv('data/drug_interaction/ddis.csv')
